/**
 * 图标定义 — Lucide SVG 路径集合
 *
 * 每个键映射到对应的 SVG inner content（viewBox 24x24），
 * 与业务逻辑分离，便于独立维护。
 */
...
const ICONS = {
  ...
  'sliders':  '<path d="M4 21v-7"/><path d="M4 10V3"/><path d="M12 21v-9"/><path d="M12 8V3"/><path d="M20 21v-5"/><path d="M20 12V3"/><line x1="2" x2="6" y1="14" y2="14"/><line x1="10" x2="14" y1="8" y2="8"/><line x1="18" x2="22" y1="16" y2="16"/>',
};
